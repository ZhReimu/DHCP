...
public class DHCPOption implements Serializable {
    ...
    public static byte[] short2Bytes(short val) {
        return new byte[]{(byte) ((val & 0xFF00) >>> 8), (byte) (val & 0XFF)};
    }

    public static byte[] int2Bytes(int val) {
        return new byte[]{(byte) ((val & 0xFF000000) >>> 24),
    ...
    public static void main(String[] args) {
        ...
        StringBuilder inet1 = new StringBuilder();
        StringBuilder inets = new StringBuilder();
        StringBuilder int1 = new StringBuilder();
        StringBuilder short1 = new StringBuilder();
