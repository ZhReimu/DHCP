...
public final class DHCPConstants {
     ...
     * @return the map
     */
    public static Map<Byte, String> getBootNamesMap() {
        return _BOOT_NAMES;
    }
     ...
     * @return the map
     */
    public static Map<Byte, String> getHtypesMap() {
        return _HTYPE_NAMES;
    }
     ...
     * @return the map
     */
    public static Map<Byte, String> getDhcpCodesMap() {
        return _DHCP_CODES;
    }
     ...
     * @return the map
     */
    public static Map<Byte, String> getDhoNamesMap() {
        return _DHO_NAMES;
    }
     ...
     * @return the map
     */
    public static Map<String, Byte> getDhoNamesReverseMap() {
